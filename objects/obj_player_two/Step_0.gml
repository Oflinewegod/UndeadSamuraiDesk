...
move_right = (gamepad_axis_value(global.ptwo, gp_axislh) > 0 ) or gamepad_button_check(global.ptwo, gp_padr)
move_left = (gamepad_axis_value(global.ptwo, gp_axislh) < 0 ) or gamepad_button_check(global.ptwo, gp_padl )
jump_pressed = gamepad_button_check_pressed(global.ptwo, gp_face1)
throw_shuriken = gamepad_button_check(global.ptwo, gp_face2)	
...
if keyboard_check_released(ord("P")) or gamepad_button_check_released(global.ptwo, gp_face2){released = true} //prevents you from just holding the throw button
